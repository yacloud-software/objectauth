...
require (
	...
	golang.conradwood.net/apis/auth v1.1.2707
	golang.conradwood.net/apis/common v1.1.2707
	...
	golang.conradwood.net/go-easyops v0.1.23008
...
require (
	...
	golang.conradwood.net/apis/goeasyops v1.1.2707 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.2707 // indirect
