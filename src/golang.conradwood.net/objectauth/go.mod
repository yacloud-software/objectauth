...
require (
	...
	golang.conradwood.net/apis/auth v1.1.4117
	golang.conradwood.net/apis/common v1.1.4117
...
require (
	...
	golang.conradwood.net/apis/goeasyops v1.1.4117 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.4117 // indirect
